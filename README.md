В файле "final_project_e-shanina.md" представлен ход решения задачи. В файле "final_project_e-shanina_python .ipynb" представлен Python код для решения пункта 2. 
